...
def test_source_output_id_is_the_output_identifier():
    intent = _intentForOutput(_out("image", True, name="mySeg"), _URL, _NAME, _JOB_ID)
...
_EMITTED_CASES = {
    "add-segment-group.embedded": {
        **_intentForOutput(_out("image", True), _URL, _NAME, _JOB_ID),
        "id": _RESULT_ID,
    },
    "add-base-image": {
        **_intentForOutput(_out("image", False), _URL, _NAME, _JOB_ID),
        "id": _RESULT_ID,
    },
    "ordinary-file": {
        **_intentForOutput(_out("file", False), _URL, _NAME, _JOB_ID),
        "id": _RESULT_ID,
    },
}
